...
"""
Connecticut elections have CSV results files for general elections from 2002-2010.
"""
...
class LoadResults(object):
    ...
    def run(self, mapping):
        ...
        if 'precinct' in election_id:
            loader = CTPrecinctLoader()
        else:
            loader = CTCountyLoader()
        loader.run(mapping)

class CTBaseLoader(BaseLoader):
